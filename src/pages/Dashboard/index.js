      ...
      >
        ...
        <View style={{width : '100%',
         ...
         {products.map((product)=> {
          ...
          return(
            <TouchableOpacity style={{width : '50%', backgroundColor : '#ffffff', height : 300, padding : 5, marginBottom : 20,}} onPress ={() => navigation.navigate('DetailProduct', {id: product.id})} key={product.id}>
              <View style={{ padding : 5, height :290, borderRadius : 3, borderWidth : 0.1, borderColor : colors.disable, backgroundColor:'#f9fcfb'}}>
                <View style={{flex:1}}>
                  ...
                  <Text>{product.description.length > 60 ? product.description.substr(0, 100) + '[..]' : product.description }</Text>
                </View>
